...
const en: Dict = {
  ...
  competition: {
    ...
    rules: [
      { num: '01', title: 'Selection', text: '30 participants will be confirmed for the competition. The list of confirmed participants will be published on 7 July 2026.' },
  ...
  registration: {
    ...
    success_text: 'Thank you! Your application has been successfully submitted. We will publish the list of confirmed participants on 7 July 2026.',
