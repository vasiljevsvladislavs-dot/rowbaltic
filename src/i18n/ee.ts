...
const ee: Dict = {
  ...
  competition: {
    ...
    rules: [
      { num: '01', title: 'Valik', text: 'Konkursile kinnitatakse 30 osalejat. Kinnitatud osalejate nimekiri avaldatakse 7. juulil 2026.' },
  ...
  registration: {
    ...
    success_text: 'Täname! Teie avaldus on edukalt esitatud. Avaldame kinnitatud osalejate nimekirja 7. juulil 2026.',
