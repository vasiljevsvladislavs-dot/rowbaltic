...
const ee: Dict = {
  ...
  competition: {
    ...
    rules: [
      { num: '01', title: 'Registreerimine', text: 'Esitage kahe viimase aasta tööde portfolio ja sotsiaalmeedia profiil. Registreerimine toimub veebilehel rowbaltic.com kuni 22. juunini 2026 kell 23:59.' },
  ...
  registration: {
    ...
    f_file: 'Portfolio fail (PDF või ZIP, maks. 10MB)',
    f_wall_size: 'Eelistatud seina suurus',
    f_wall_default: 'Valige...',
    f_shirt: 'T-särgi suurus *',
    f_shirt_default: 'Valige...',
    f_baltic_label: 'Olen Balti kunstnik',
    f_baltic_desc: 'Läti, Leedu või Eesti — lisainfo hotellibroneeringuks',
    f_fullname: 'Eesnimi Perekonnanimi *',
    f_fullname_ph: 'Jaan Tamm',
    f_code: 'Isikukood *',
    ...
    contact_label: 'Küsimused: info@rowbaltic.com',
