...
const lt: Dict = {
  ...
  competition: {
    ...
    rules: [
      { num: '01', title: 'Registracija', text: 'Pateikite paskutinių dvejų metų darbų portfolio ir socialinių tinklų profilį. Registracija vyksta rowbaltic.com svetainėje iki 2026 m. birželio 22 d. 23:59.' },
  ...
  registration: {
    ...
    f_file: 'Portfolio failas (PDF arba ZIP, maks. 10MB)',
    ...
    contact_label: 'Klausimai: info@rowbaltic.com',
