...
const lt: Dict = {
  ...
  competition: {
    ...
    rules: [
      { num: '01', title: 'Atranka', text: 'Konkursui bus patvirtinti 30 dalyvių. Patvirtintų dalyvių sąrašas bus paskelbtas 2026 m. liepos 7 d.' },
  ...
  registration: {
    ...
    success_text: 'Ačiū! Jūsų paraiška sėkmingai pateikta. Patvirtintų dalyvių sąrašą paskelbsime 2026 m. liepos 7 d.',
