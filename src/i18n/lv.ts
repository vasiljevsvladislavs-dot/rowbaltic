...
const lv: Dict = {
  ...
  competition: {
    ...
    rules: [
      { num: '01', title: 'Pieteikšanās', text: 'Iesniedziet portfolio ar pēdējo divu gadu darbiem un sociālo tīklu profilu. Pieteikšanās notiek mājaslapā rowbaltic.com līdz 2026. gada 22. jūnijam plkst. 23:59.' },
  ...
  registration: {
    ...
    f_file_selected: (n: number) => `${n} fails(-i) izvēlēts(-i)`,
    ...
    f_baltic_label: 'Es esmu Baltijas mākslinieks',
    f_baltic_desc: 'Latvija, Lietuva vai Igaunija — papildu informācija viesnīcas rezervācijai',
    f_fullname: 'Vārds Uzvārds *',
    f_fullname_ph: 'Jānis Bērziņš',
    f_code: 'Personas kods *',
    ...
    contact_label: 'Jautājumi: info@rowbaltic.com',
