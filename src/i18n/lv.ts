...
const lv: Dict = {
  ...
  programma: {
    ...
    art_desc: 'Daiņa Rudens vadībā. 30 Latvijas un ārzemju ielu mākslinieki veidos 400m² lielu sienas gleznojumu.',
    ...
    letters_title: 'Burtveidolu darbnīca ar Valteru Kalseru',
    ...
    brewery_title: 'Mežpils ražotnes un alus muzeja apmeklējums',
    brewery_desc: 'Vada alus vēstnesis Edgars Magons.',
